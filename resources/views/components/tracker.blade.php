<div id="tracker-{{ $tracker->id }}" class="tracker grid relative">
    <div class="w-full flex flex-col space-y-3 px-6 py-3 border border-gray-300 rounded-md">
        ...
        <div id="tracker-{{ $tracker->id }}-info" class="boat-info hidden absolute top-24 right-0 z-10 flex flex-col space-y-2 p-2 border border-gray-200 bg-white rounded-md">
