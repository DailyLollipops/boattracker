                ...
                @foreach($logs as $log)
                    <div class="table-row-group">
                        <div class="table-row font-sans font-medium text-gray-600 text-md">
                            ...
                            <div class="table-cell text-right w-1/6 pr-4 py-4">
                                {{$log->boat->name}}
                                <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48" class="fill-gray-800 w-4 h-4 inline cursor-pointer">
